...
{
    // Testing Delete
    public static bool DeleteTest(int seed, IFileSystem expected, IFileSystem output)
    {
        ...
        // Rutina 1 eliminando archivos
        Action<IFileSystem> routine1 = fs => 
        {
            fs.Delete("/Downloads/system_0.dll");
            fs.Delete("/Music/system_0.dll");
            fs.Delete("/Videos/system_0.dll");
        };
        ...
        // Rutina 2 eliminando carpetas
        Action<IFileSystem> routine2 = fs => 
        {
            fs.Delete("/Music/Downloads");
            fs.Delete("/Downloads/Music/Videos");
        };
